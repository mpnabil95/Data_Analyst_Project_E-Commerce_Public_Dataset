...
> Dokumentasi perubahan `app_2_v1.py` hingga `app_2_v14.py`  
> Proyek: **FP-E-Commerce — Olist Commerce Intelligence**  
> Framework: **Streamlit, Pandas, Plotly, Folium, dan Streamlit-Folium**  
> Versi final yang direkomendasikan: **`app_2_v14.py`**

---

## 1. Tujuan Dokumentasi

Dokumen ini menjelaskan evolusi dashboard e-commerce berbasis Streamlit mulai dari revisi pertama (`app_2_v1.py`) sampai versi final (`app_2_v14.py`). Dokumentasi disusun untuk:
...
Sebelum seri revisi `v1–v14`, dashboard awal sudah memiliki fondasi analitik yang lengkap. Dashboard dirancang untuk Brazilian E-Commerce Public Dataset by Olist dan memproses sembilan dataset utama:
...
Seri `v1–v14` berfokus untuk menyelesaikan masalah-masalah tersebut tanpa mengubah inti analisis data.
...
`app_2_v14.py` merupakan versi final yang direkomendasikan sebagai source utama deployment.
...
| `v14` | Plotly dark-native: background, font, grid, tooltip, legend, colorbar, dan annotation diselaraskan |
...
| `v13–v14` | API native KPI final dengan optional delta/note/spark dan key unik |
...
| `v14` | Dark mode only dan konsisten |
...
7. KPI native final pada `v13–v14`.
...
| Versi | Plotly kontras | Parent data path | Sparkline | Sanitasi KPI | Native KPI | Responsive | Dual theme | Dark-only |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| `v1` | ✅ | — | — | Dasar | — | — | — | — |
| `v2` | ✅ | ✅ | — | Dasar | — | — | — | — |
| `v3` | ✅ | ✅ | — | Dasar | — | — | — | — |
...
Versi final mempertahankan arsitektur data berikut:
...
- **CSS custom** untuk design system dark mode dan responsive behavior;
- **HTML terbatas** untuk hero dan elemen dekoratif yang tidak menerima input bebas.

---

# 8. Perubahan yang Tidak Mengubah Logika Analitik

Sebagian besar revisi `v4–v14` berfokus pada presentasi. Hal-hal berikut pada dasarnya tetap dipertahankan:
...
```text
FP-E-Commerce/
├── app_2.py                         # Salinan produksi dari app_2_v14.py
├── requirements.txt
├── README.md
├── .gitignore
├── .streamlit/
...
Isi file tersebut adalah salinan dari `app_2_v14.py`. Riwayat lama dapat disimpan dalam folder `archive/` atau dipindahkan ke Git history.

Tag release yang disarankan:

```text
v1.0.0-dashboard-dark
```

Contoh judul release:

```text
Olist Commerce Intelligence Dashboard — Dark Mode Final
```
...
- [ ] Salin `app_2_v14.py` menjadi `app_2.py`.
...
Pengembangan `app_2.py` dari `v1` hingga `v14` dapat dibagi menjadi empat fase utama:
...
4. **konsolidasi dark-only (`v14`)** — menyatukan seluruh dashboard dalam design system gelap yang konsisten dan siap dipublikasikan.

Versi final mempertahankan kemampuan analitik dari dashboard awal, tetapi meningkatkan portabilitas, stabilitas rendering, keterbacaan, responsivitas, dan kualitas visual secara signifikan. Untuk penggunaan produksi dan portfolio GitHub, `app_2_v14.py` merupakan baseline yang direkomendasikan.

---

**Dokumen terakhir diperbarui:** 19 Juli 2026  
**Status:** Final documentation for GitHub preparation
